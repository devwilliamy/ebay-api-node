const car03WithNoMirrorNewHtml = `<!DOCTYPE html>
      <html
        lang="en"
        ...
        <body>
          ...
          <section class="highQualitySection">
            <picture class="dynamicImage">
              <source class="dynamicImage" srcset="https://advanceparts.sfo3.cdn.digitaloceanspaces.com/ebay/car_03_description/lifestyle_car_03_nm.webp" media="(min-width: 601px)" />
              <img class="dynamicImage" src="https://advanceparts.sfo3.cdn.digitaloceanspaces.com/ebay/car_03_description/lifestyle_car_03_m_nm.webp" alt="High-Quality Premium Car Cover" />
            </picture>
          ...
          <div class="imageSection">
            ...
            <picture class="dynamicImage">
              <source class="dynamicImage" srcset="https://advanceparts.sfo3.cdn.digitaloceanspaces.com/ebay/car_03_description/air_nm.webp" media="(min-width: 601px)" />
              <img
                class="dynamicImage"
                src="https://advanceparts.sfo3.cdn.digitaloceanspaces.com/ebay/car_03_description/air_m_nm.webp"
          ...
          <picture class="dynamicImage">
            <source class="dynamicImage" srcset="https://advanceparts.sfo3.cdn.digitaloceanspaces.com/ebay/car_03_description/antiproof_nm.webp" media="(min-width: 601px)" />
            <img
              class="dynamicImage waterproofSnowproof"
              src="https://advanceparts.sfo3.cdn.digitaloceanspaces.com/ebay/car_03_description/antiproof_m_nm.webp"
...
module.exports = car03WithNoMirrorNewHtml
