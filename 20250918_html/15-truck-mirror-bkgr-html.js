const truck_mirror_15_bkgr_html = `     <!DOCTYPE html>
      <html
        lang="en"
        ...
        <body>
          ...
          <section class="highQualitySection">
            <picture class="dynamicImage">
              <source class="dynamicImage" srcset="https://icarcover.sfo3.cdn.digitaloceanspaces.com/ebay/desc/truck/15/a-main-truck-15-bkgr-desktop-mirror.webp" media="(min-width: 601px)" />
              <img class="dynamicImage" src="https://icarcover.sfo3.cdn.digitaloceanspaces.com/ebay/desc/truck/15/a-main-truck-15-bkgr-mobile-mirror.webp" alt="High-Quality Premium Truck Cover" />
            </picture>
          ...
          <div class="imageSection">
            ...
            <picture class="dynamicImage">
              <source class="dynamicImage" srcset="https://icarcover.sfo3.cdn.digitaloceanspaces.com/ebay/desc/truck/15/a-airvent-truck-15-bkgr-desktop-mirror.webp" media="(min-width: 601px)" />
              <img
                class="dynamicImage"
                src="https://icarcover.sfo3.cdn.digitaloceanspaces.com/ebay/desc/truck/15/a-airvent-truck-15-bkgr-mobile-mirror.webp"
          ...
          <div class="ultimateToolkitSection imageSection">
            ...
            <div class="toolkitGrid">
              ...
              <div class="toolkitGridItem">
                ...
                <p class="gridDescription">
                  Ensuring your truck cover stays securely in place, no matter the weather.
                </p>
              </div>
            </div>
          </div>
          ...
          <picture class="dynamicImage">
            <source class="dynamicImage" srcset="https://icarcover.sfo3.cdn.digitaloceanspaces.com/ebay/desc/truck/15/a-weatherproof-truck-15-bkgr-desktop-mirror.webp" media="(min-width: 601px)" />
            <img
              class="dynamicImage waterproofSnowproof"
              src="https://icarcover.sfo3.cdn.digitaloceanspaces.com/ebay/desc/truck/15/a-weatherproof-truck-15-bkgr-mobile-mirror.webp"
...
module.exports = truck_mirror_15_bkgr_html;