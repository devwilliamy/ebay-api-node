const truck_no_mirror_03_html = `<!DOCTYPE html>
      <html
        lang="en"
        ...
        <body>
          ...
          <section class="highQualitySection">
            <picture class="dynamicImage">
              <source class="dynamicImage" srcset="https://icarcover.sfo3.cdn.digitaloceanspaces.com/ebay/desc/truck/03/a-main-truck-03-desktop-no-mirror.webp" media="(min-width: 601px)" />
              <img class="dynamicImage" src="https://icarcover.sfo3.cdn.digitaloceanspaces.com/ebay/desc/truck/03/a-main-truck-03-mobile-no-mirror.webp" alt="High-Quality Premium Truck Cover" />
            </picture>
          ...
          <div class="imageSection">
            ...
            <picture class="dynamicImage">
              <source class="dynamicImage" srcset="https://icarcover.sfo3.cdn.digitaloceanspaces.com/ebay/desc/truck/03/a-airvent-truck-03-desktop-no-mirror.webp" media="(min-width: 601px)" />
              <img
                class="dynamicImage"
                src="https://icarcover.sfo3.cdn.digitaloceanspaces.com/ebay/desc/truck/03/a-airvent-truck-03-mobile-no-mirror.webp"
          ...
          <picture class="dynamicImage">
            <source class="dynamicImage" srcset="https://icarcover.sfo3.cdn.digitaloceanspaces.com/ebay/desc/truck/03/a-weatherproof-truck-03-desktop-no-mirror.webp" media="(min-width: 601px)" />
            <img
              class="dynamicImage waterproofSnowproof"
              src="https://icarcover.sfo3.cdn.digitaloceanspaces.com/ebay/desc/truck/03/a-weather-truck-03-mobile-no-mirror.webp"
...
module.exports = truck_no_mirror_03_html;
