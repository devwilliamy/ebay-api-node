const truck_mirror_10_html = `     <!DOCTYPE html>
      <html
        lang="en"
        ...
        <body>
          ...
          <section class="highQualitySection">
            <picture class="dynamicImage">
              <source class="dynamicImage" srcset="https://icarcover.sfo3.cdn.digitaloceanspaces.com/ebay/desc/truck/10/a-main-truck-10-desktop-mirror.webp" media="(min-width: 601px)" />
              <img class="dynamicImage" src="https://icarcover.sfo3.cdn.digitaloceanspaces.com/ebay/desc/truck/10/a-main-truck-10-mobile-mirror.webp" alt="High-Quality Premium Truck Cover" />
            </picture>
          ...
          <div class="imageSection">
            ...
            <picture class="dynamicImage">
              <source class="dynamicImage" srcset="https://icarcover.sfo3.cdn.digitaloceanspaces.com/ebay/desc/truck/10/a-airvent-truck-10-desktop-mirror.webp" media="(min-width: 601px)" />
              <img
                class="dynamicImage"
                src="https://icarcover.sfo3.cdn.digitaloceanspaces.com/ebay/desc/truck/10/a-airvent-truck-10-mobile-mirror.webp"
          ...
          <picture class="dynamicImage">
            <source class="dynamicImage" srcset="https://icarcover.sfo3.cdn.digitaloceanspaces.com/ebay/desc/truck/10/a-weatherproof-truck-10-desktop-mirror.webp" media="(min-width: 601px)" />
            <img
              class="dynamicImage waterproofSnowproof"
              src="https://icarcover.sfo3.cdn.digitaloceanspaces.com/ebay/desc/truck/10/a-weather-truck-10-mobile-mirror.webp"
...
module.exports = truck_mirror_10_html;